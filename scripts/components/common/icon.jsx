UI.common.icon = React.createClass({
	...
	render() {
		...
		var style = this.props.style ? ' icon-' + this.props.style : '';
		return (
			<div className={'icon' + style + size}>
				<svg x="0px" y="0px" viewBox="0 0 126.1 186.6" enable-background="new 0 0 126.1 186.6">
				
						<path className="main-stick" d="M5.9,186.6c-2.2,0-4.3-1.2-5.3-3.4c-1.4-2.9-0.1-6.5,2.8-7.9l114.3-54.2c2.9-1.4,6.5-0.1,7.9,2.8
							c1.4,2.9,0.1,6.5-2.8,7.9L8.4,186C7.6,186.4,6.8,186.6,5.9,186.6z"/>
				
						<path className="accent-stick" d="M41.8,149.7c-0.9,0-1.7-0.2-2.6-0.6L3.3,131.8c-2.9-1.4-4.2-4.9-2.8-7.9c1.4-2.9,5-4.2,7.9-2.8l35.9,17.3
							c2.9,1.4,4.2,4.9,2.8,7.9C46.1,148.5,44,149.7,41.8,149.7z"/>
				
						<path className="accent-stick" d="M120.2,186.4c-0.9,0-1.7-0.2-2.6-0.6l-35.5-17.2c-2.9-1.4-4.2-5-2.7-7.9c1.4-2.9,5-4.2,7.9-2.7l35.5,17.2
							c2.9,1.4,4.2,5,2.7,7.9C124.5,185.2,122.4,186.4,120.2,186.4z"/>
				
						<path className="fire-main" d="M63.6,132.9c-26.3,0-47.7-21.4-47.7-47.7c0-10.2,5.9-17,11-23.1c6.3-7.3,9.7-11.9,7-19.8
